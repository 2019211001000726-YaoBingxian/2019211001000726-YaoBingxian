		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.YaoBingxian.model.Order o=(com.YaoBingxian.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.YaoBingxian.dao.UserDao userDao=new com.YaoBingxian.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.YaoBingxian.model.Payment.findByPaymentId(con,n);
						%>
